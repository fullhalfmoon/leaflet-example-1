...
(function (window, document, undefined) {
	...
	function loadData() {
		...
		const AREA_2 = 'いいいい';
		let data_1 = [
			{type:LEAFLET_MARKER, area:AREA_1, latLng:[35.06841434635014, 136.02219521999362], color:MARKER_COLOR_ORIGINAL},
			{type:LEAFLET_MARKER, area:AREA_1, latLng:[35.06758232400261, 136.02373212575915], color:MARKER_COLOR_ORIGINAL},
			{type:LEAFLET_MARKER, area:AREA_2, latLng:[35.067033491954106, 136.02481573820114], color:MARKER_COLOR_ORIGINAL},
			{type:LEAFLET_MARKER, area:AREA_2, latLng:[35.06376676725211, 136.0306254029274], color:MARKER_COLOR_ORIGINAL}
		];
		*/
